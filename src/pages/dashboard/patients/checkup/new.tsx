        ...
        <form onSubmit={methods.handleSubmit(onSubmit)}>
          <div className="space-y-6">
            ...
            <div className="flex justify-end">
              <button ref={sumbitRef} type="submit" />
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription className="line-clamp-4">
                      Tindakan ini permanen dan tidak dapat diubah. Mohon
                      pastikan informasi yang dimasukkan akurat. Jika perlu
                      bantuan, hubungi tim dukungan kami.
                    </AlertDialogDescription>
                  </AlertDialogHeader>
                  <AlertDialogFooter>
